...
> This note is superseded by `docs/research/prior-art/orchestra/orchestra-current-v2-audit.md`.
...
- `docs/research/workflow/workflow-behavior-evals.md`: evals should test behavior under ambiguity, backward re-entry, crisp communication, and memory artifact use.
- `docs/plans/skills/skill-inventory-and-plugin-plan.md`: old `orchestra` should be treated as source material and failure evidence, not a base implementation.
