# Freeflow Artifact Skills

Date: 2026-05-25

## Decision

Freeflow should build three separate artifact skills:
...
- Freeflow `review-work`: blocking / non-blocking / question classification.
...
- Freeflow `interview-gate`: planning must stop on hidden user-owned decisions.
