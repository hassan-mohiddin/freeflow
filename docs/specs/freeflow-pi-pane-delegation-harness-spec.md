...
> **Type:** Spec
> **Status:** Draft
> **Source:** Shared delegation-harness discovery session, `docs/designs/local-delegation-harness-design.md`, Codex CLI agent-harness research passes 4/6/7/8, Pi sessions/extensions/model docs, current Freeflow workflow and output-router skills.
...
SOURCE|spec|docs/specs/freeflow-pi-pane-delegation-harness-spec.md
SOURCE|plan|docs/plans/2026-07-01-freeflow-pi-pane-delegation-harness-implementation-plan.md
