...
> **Source:** 2026-06-18 router architecture research and grilling; live router files; `docs/specs/output-router/freeflow-output-router-design.md`; `docs/specs/output-router/freeflow-output-router-excellence-spec.md`; `docs/handoffs/output-router/2026-06-18-output-router-review-and-architecture-next.md`
...
- `docs/specs/output-router/freeflow-output-router-design.md` requires explicit routed tools, raw capture before transformation, exact recovery, no surprise semantics, and deterministic runtime behavior.
- `docs/specs/output-router/freeflow-output-router-excellence-spec.md` makes accuracy non-negotiable and keeps optional index adoption behind evidence gates.
- `docs/handoffs/output-router/2026-06-18-output-router-review-and-architecture-next.md` records current review blockers and the decision to run architecture research before more fixes.
