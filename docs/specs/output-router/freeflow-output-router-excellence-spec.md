...
This spec complements, and does not replace, `docs/specs/output-router/freeflow-output-router-design.md`.
...
15. This companion spec lives at `docs/specs/output-router/freeflow-output-router-excellence-spec.md` and complements the existing router design.
