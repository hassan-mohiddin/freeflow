...
This spec supersedes the prior call-through-first provider direction in `docs/specs/output-processing/freeflow-universal-output-capture-and-derive-design.md` where host post-tool output replacement is available.
