...
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-0-repo-map.md` - 1,208 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-1-turn-loop.md` - 1,802 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-2-tool-system.md` - 2,471 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-3-sandboxing-and-permissions.md` - 2,499 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-4-subagents-and-delegation.md` - 2,285 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-5-model-providers-runtime-adapters.md` - 1,691 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-6-memory-and-context.md` - 3,498 lines
- `docs/codex-cli-agent-harness/passes/2026-06-12-pass-7-config-and-extensibility.md` - 1,644 lines
- `docs/codex-cli-agent-harness/passes/2026-06-13-pass-8-agent-harness-comparisons.md` - 3,189 lines
...
2. `docs/codex-cli-agent-harness/passes/2026-06-13-pass-8-agent-harness-comparisons.md`
...
3. `docs/codex-cli-agent-harness/passes/2026-06-12-pass-3-sandboxing-and-permissions.md`
   - local harness safety corrections: `2026-06-12-pass-3-sandboxing-and-permissions.md:1515-1525`

4. `docs/codex-cli-agent-harness/passes/2026-06-12-pass-4-subagents-and-delegation.md`
...
5. `docs/codex-cli-agent-harness/passes/2026-06-12-pass-5-model-providers-runtime-adapters.md`
   - provider/runtime open questions: `2026-06-12-pass-5-model-providers-runtime-adapters.md:1494-1503`

6. `docs/codex-cli-agent-harness/passes/2026-06-12-pass-6-memory-and-context.md`
...
7. `docs/codex-cli-agent-harness/passes/2026-06-12-pass-7-config-and-extensibility.md`
