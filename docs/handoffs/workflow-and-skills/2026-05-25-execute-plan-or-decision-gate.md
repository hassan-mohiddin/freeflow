...
- `CONTEXT.md`
- `docs/adr/`
- `docs/research/memory-and-artifacts/freeflow-artifact-skills.md`
...
- Untracked artifact skill docs/reports/prompts/fixtures:
  - `docs/research/memory-and-artifacts/freeflow-artifact-skills.md`
  - `docs/handoffs/workflow-and-skills/2026-05-25-artifact-skills-handoff.md`
  - `docs/handoffs/workflow-and-skills/2026-05-25-write-plan-next.md`
  - `docs/handoffs/workflow-and-skills/2026-05-25-execute-plan-or-decision-gate.md`
  - `skills/write-spec/`
...
```text
Read AGENTS.md, CONTEXT.md, docs/adr/, and docs/handoffs/workflow-and-skills/2026-05-25-execute-plan-or-decision-gate.md.
