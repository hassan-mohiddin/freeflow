...
1. `docs/research/workflow/agent-workflow-plugin-context.md`
   - Captures the original product direction and reasoning.
2. `docs/plans/skills/skill-inventory-and-plugin-plan.md`
...
4. `docs/research/workflow/workflow-behavior-evals.md`
