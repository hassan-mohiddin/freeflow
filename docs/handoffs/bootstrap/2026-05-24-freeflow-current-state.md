...
- Behavior evals: `docs/research/workflow/workflow-behavior-evals.md`
...
```text
Read docs/handoffs/bootstrap/2026-05-24-freeflow-current-state.md, then continue by drafting the freeflow handoff skill. Do not edit until you have read the current core skills and plugin contract.
```
