# Pilot Workflow Current-State Handoff

Date: 2026-05-24

## Purpose

This handoff lets a fresh agent continue pilot-workflow development after conversation compaction.

Use this file as a pointer to current state, not as the only source of truth.

## Key Paths

- Plugin draft: `plugins/pilot-workflow/`
- Core skills: `plugins/pilot-workflow/skills/`
- Plugin contract: `docs/plugin-contract.md`
- Behavior evals: `docs/workflow-behavior-evals.md`
- Eval reports: `plugins/pilot-workflow/evals/*report.md`
- Codex eval harness: `plugins/pilot-workflow/evals/scripts/run-codex-fixture-eval.sh`
...
```text
Read docs/handoffs/2026-05-24-pilot-workflow-current-state.md, then continue by drafting the pilot-workflow handoff skill. Do not edit until you have read the current core skills and plugin contract.
```
