...
> **Type:** Plan
> **Status:** Draft
> **Source:** `docs/specs/output-router/freeflow-router-architecture-deepening-spec.md`

# Freeflow Router Architecture Deepening Plan

## Goal

Execute the router architecture deepening program described in `docs/specs/output-router/freeflow-router-architecture-deepening-spec.md` without changing the public Output Router contract.
...
- `docs/specs/output-router/freeflow-router-architecture-deepening-spec.md`
