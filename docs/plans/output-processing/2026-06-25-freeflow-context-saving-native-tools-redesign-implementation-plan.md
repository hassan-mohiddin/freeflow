...
> **Source:** `docs/specs/output-processing/freeflow-context-saving-native-tools-redesign-spec.md`

# Freeflow Context-Saving Native Tools Redesign Implementation Plan

## Goal

Implement the Freeflow-owned tool redesign from `docs/specs/output-processing/freeflow-context-saving-native-tools-redesign-spec.md` without broad public rename churn until performance is proven.
...
- `docs/specs/output-processing/freeflow-context-saving-native-tools-redesign-spec.md`
