...
export function selectEvidenceRangeForChunk(options: SelectEvidenceRangeForChunkOptions): EvidenceRangeSelection {
...
function exactPhraseRangeForChunk(options: SelectEvidenceRangeForChunkOptions): LineRange | null {
...
function bestLineIndexInChunk(options: SelectEvidenceRangeForChunkOptions): number {
...
function queryCoverageRangeForChunk(options: SelectEvidenceRangeForChunkOptions): LineRange | null {
...
function fencedCodeBlocksInChunk(options: SelectEvidenceRangeForChunkOptions): LineRange[] {
