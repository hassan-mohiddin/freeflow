...
function requiredVisiblePrefix(input: ProcessingRenderInput): string {
...
function processingScriptPolicyLine(script: ScriptPolicySelectionResult | undefined): string {
...
function truncateVisible(text: string, maxBytes: number, requiredPrefix = ""): string {
