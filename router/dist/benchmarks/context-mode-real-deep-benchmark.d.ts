...
export declare function runContextModeRealDeepBenchmark(
...
export declare function writeContextModeRealDeepBenchmarkReports(
...
export declare function baselineFailureClassesDetected(
  report: Pick<ContextModeRealDeepReport, "failureClusters">,
): boolean;
