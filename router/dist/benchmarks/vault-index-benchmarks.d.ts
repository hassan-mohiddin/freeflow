...
export declare function runVaultIndexStorageBenchmark(
...
export declare function writeVaultIndexStorageBenchmarkReport(
  report: VaultIndexStorageBenchmarkReport,
  reportPath: string,
): Promise<void>;
export declare function writeVaultIndexStorageBenchmarkReports(
  report: VaultIndexStorageBenchmarkReport,
