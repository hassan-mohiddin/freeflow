import type { CommandParserMetadata, ExecutionStatus } from "../config/types.js";
...
export declare function writeCommandBenchmarkJsonReport(
...
export declare function writeCommandBenchmarkReports(
  report: CommandBenchmarkReport,
