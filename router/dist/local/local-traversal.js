...
export async function collectLocalTextFileRefs(options) {
    ...
    const budget = { directories: 0, files: 0, bytes: 0 };
...
async function resolveLocalRequestedPath(rootRealPath, requestedPath) {
...
function hasSecretFileName(name) {
...
function broadRootRejectionReason(rootRealPath) {
...
function safeNormalizeAbsolutePath(path) {
    try {
