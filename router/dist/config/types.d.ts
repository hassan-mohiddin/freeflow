...
export declare const ROUTE_KINDS: readonly [
  "retrieve",
  "run",
  "transform",
  "batch",
...
export declare const PRODUCER_KINDS: readonly [
  "command",
  "script",
  "native",
  "repo",
...
export declare const ROUTER_FAILURE_KINDS: readonly [
  "adapter_unavailable",
  "storage_failure",
...
export declare const FAILURE_EXECUTION_STATUSES: readonly [
  "unavailable",
  "unsupported",
  "rejected",
  "failed",
...
export declare const OBSERVED_PRODUCER_RISK_SOURCES: readonly [
  "configured",
  "mcp_annotation",
  "manifest",
  "heuristic",
