...
export declare const SCRIPT_SANDBOX_REQUIRED_PROOFS: readonly [
  "env_access_denied",
  "home_access_denied",
  "repo_access_denied",
  "vault_access_denied",
...
export declare function scriptSandboxProofFixturesForLanguage(language: ScriptTransformLanguage): Array<
  Omit<ScriptSandboxProofFixture, "programs"> & {
    program: string;
  }
>;
...
export declare function probeScriptSandboxAdapters(
  options?: ProbeScriptSandboxAdaptersOptions,
): Promise<ScriptSandboxProbeReport>;
export declare function selectScriptSandboxAdapter(
  language: ScriptTransformLanguage,
  config: ScriptTransformConfig,
  adapters?: readonly ScriptSandboxAdapter[],
): Promise<
