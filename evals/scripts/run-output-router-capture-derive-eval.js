...
const REPORT_PATH = "evals/reports/runtime/output-router-capture-derive-provider-eval-1-report.md";
...
\`\`\`sh
npm run build && node evals/scripts/run-output-router-capture-derive-eval.js
\`\`\`
