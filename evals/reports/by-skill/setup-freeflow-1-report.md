...
- With skill: `skills/setup-freeflow/SKILL.md`
...
- `evals/fixtures/tiny-setup-agents-app/`
- `evals/fixtures/tiny-setup-both-app/`
- `evals/fixtures/tiny-setup-conflict-app/`
- `evals/fixtures/tiny-setup-existing-block-app/`

Added prompts:

- `evals/prompts/stp-001.txt`
- `evals/prompts/stp-002.txt`
- `evals/prompts/stp-003.txt`
- `evals/prompts/stp-004.txt`
...
- `evals/runs/setup-1/stp-001-baseline-output.md`
- `evals/runs/setup-2/stp-001-with-skill-output.md`
- `evals/runs/setup-1/stp-002-baseline-output.md`
- `evals/runs/setup-2/stp-002-with-skill-output.md`
- `evals/runs/setup-1/stp-003-baseline-output.md`
- `evals/runs/setup-2/stp-003-with-skill-output.md`
- `evals/runs/setup-4/stp-004-baseline-output.md`
- `evals/runs/setup-4/stp-004-with-skill-output.md`
...
wc -c evals/runs/setup-*/stp-*-output.diff
wc -l skills/setup-freeflow/SKILL.md
```
