...
```sh
evals/scripts/grade-fixture-eval.sh RAR-005 --output evals/runs/review-artifact-pi-5/rar-005-with-skill-output.md
evals/scripts/grade-fixture-eval.sh RAR-004 --output evals/runs/review-artifact-pi-6/rar-004-with-skill-output.md
```
