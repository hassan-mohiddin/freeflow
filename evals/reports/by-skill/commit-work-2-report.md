...
bash -n evals/fixtures/tiny-commit-staged-mixed-app/.freeflow-eval-setup.sh
wc -l skills/commit-work/SKILL.md skills/commit-work/references/staging-decisions.md
git diff --check
