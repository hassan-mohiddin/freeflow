...
- Prompt: `evals/prompts/hof-005.txt`
...
- HOF-005 final output: `evals/runs/handoff-7/hof-005/with-skill-output.md`
- HOF-005 final diff: `evals/runs/handoff-7/hof-005/with-skill-output.diff`
- HOF-002 output: `evals/runs/handoff-7/hof-002/with-skill-output.md`
- HOF-002 diff: `evals/runs/handoff-7/hof-002/with-skill-output.diff`
...
```sh
jq empty evals/registries/handoff-evals.json
...
wc -c evals/runs/handoff-7/hof-005/with-skill-output.diff
```
