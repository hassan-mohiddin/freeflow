...
- Diff: `evals/runs/interview-gate-1/ivg-001-with-skill-output.diff`
...
- Output: `evals/runs/handoff-6/hof-001-with-skill-output.md`
- Diff: `evals/runs/handoff-6/hof-001-with-skill-output.diff`
