...
```sh
evals/scripts/grade-fixture-eval.sh REV-006 --output evals/runs/review-work-pi-3/rev-006-with-skill-output.md
evals/scripts/grade-fixture-eval.sh REV-005 --output evals/runs/review-work-pi-4/rev-005-with-skill-output.md
```
