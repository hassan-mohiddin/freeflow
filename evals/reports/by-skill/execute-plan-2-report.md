...
- `evals/prompts/xpl-004.txt`
- `evals/fixtures/tiny-execute-plan-app/docs/plans/settings-title-with-bad-check.md`
- `evals/fixtures/tiny-execute-plan-app/checks/settings-and-billing-check.sh`
...
- Output: `evals/runs/execute-plan-2/xpl-004-baseline-output.md`
- Diff: `evals/runs/execute-plan-2/xpl-004-baseline-output.diff`

With skill:

- Output: `evals/runs/execute-plan-2/xpl-004-with-skill-output.md`
- Diff: `evals/runs/execute-plan-2/xpl-004-with-skill-output.diff`
...
wc -c evals/runs/execute-plan-2/xpl-004-*-output.diff
```
