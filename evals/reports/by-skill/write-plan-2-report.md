...
- Output: `evals/runs/write-plan-2/wpl-004-baseline-output.md`
- Diff: `evals/runs/write-plan-2/wpl-004-baseline-output.diff`

First with-skill failure:

- Output: `evals/runs/write-plan-2/wpl-004-with-skill-output.md`
- Diff: `evals/runs/write-plan-2/wpl-004-with-skill-output.diff`

Final with skill:

- Output: `evals/runs/write-plan-3/wpl-004-with-skill-output.md`
- Diff: `evals/runs/write-plan-3/wpl-004-with-skill-output.diff`
