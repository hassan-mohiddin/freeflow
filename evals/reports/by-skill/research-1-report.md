...
- `skills/research/LANGUAGE.md`
- `skills/research/CHECKPOINTS.md`
- `skills/research/ARTIFACT-DESTINATIONS.md`
...
- `evals/prompts/res-001.txt`
- `evals/prompts/res-002.txt`
...
- `evals/runs/research-1/res-001-baseline-output.md`
- `evals/runs/research-1/res-001-with-skill-output.md`
- `evals/runs/research-1/res-002-baseline-output.md`
- `evals/runs/research-1/res-002-with-skill-output.md`
- `evals/runs/research-2/res-002-with-skill-output.md`
- `evals/runs/research-2/res-001-with-skill-output.md`
- `evals/runs/research-command-1/cmd-012-with-skill-output.md`

Key grading commands:

```sh
evals/scripts/grade-fixture-eval.sh RES-001 --output evals/runs/research-2/res-001-with-skill-output.md
evals/scripts/grade-fixture-eval.sh RES-002 --output evals/runs/research-2/res-002-with-skill-output.md
evals/scripts/grade-fixture-eval.sh CMD-012 --output evals/runs/research-command-1/cmd-012-with-skill-output.md
```
...
- Reran `RES-001` and `RES-002` into `evals/runs/research-4/`; both final with-skill grades passed.
