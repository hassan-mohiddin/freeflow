...
- `bash -n evals/fixtures/tiny-commit-app/.freeflow-eval-setup.sh`
- `wc -l skills/commit-work/SKILL.md` => 93
...
- final response: `evals/runs/commit-work-2/cmt-001-with-skill-output.md`
