...
- `skills/discover/CHECKPOINTS.md`
- `skills/discover/ARTIFACT-DESTINATIONS.md`
...
- `evals/runs/workflow-depth/cmd-012-with-skill-output.md`
- `evals/runs/workflow-depth/dis-001-with-skill-output.md`
- `evals/runs/workflow-depth/dis-002-with-skill-output.md`

Key commands:

```sh
evals/scripts/run-fixture-eval-by-id.sh CMD-012 with-skill evals/runs/workflow-depth/cmd-012 evals/runs/workflow-depth/cmd-012-with-skill-output.md skills/discover/SKILL.md < /dev/null
evals/scripts/grade-fixture-eval.sh CMD-012 --output evals/runs/workflow-depth/cmd-012-with-skill-output.md

evals/scripts/run-fixture-eval-by-id.sh DIS-001 with-skill evals/runs/workflow-depth/dis-001 evals/runs/workflow-depth/dis-001-with-skill-output.md skills/discover/SKILL.md < /dev/null
evals/scripts/grade-fixture-eval.sh DIS-001 --output evals/runs/workflow-depth/dis-001-with-skill-output.md

evals/scripts/run-fixture-eval-by-id.sh DIS-002 with-skill evals/runs/workflow-depth/dis-002 evals/runs/workflow-depth/dis-002-with-skill-output.md skills/discover/SKILL.md < /dev/null
evals/scripts/grade-fixture-eval.sh DIS-002 --output evals/runs/workflow-depth/dis-002-with-skill-output.md
```
