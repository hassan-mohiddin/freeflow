...
- Baseline output: `evals/runs/write-plan-1/wpl-001-baseline-output.md`
- Baseline diff: `evals/runs/write-plan-1/wpl-001-baseline-output.diff`
- With-skill output: `evals/runs/write-plan-1/wpl-001-with-skill-output.md`
- With-skill diff: `evals/runs/write-plan-1/wpl-001-with-skill-output.diff`

WPL-002:

- Baseline output: `evals/runs/write-plan-1/wpl-002-baseline-output.md`
- Baseline diff: `evals/runs/write-plan-1/wpl-002-baseline-output.diff`
- With-skill output: `evals/runs/write-plan-1/wpl-002-with-skill-output.md`
- With-skill diff: `evals/runs/write-plan-1/wpl-002-with-skill-output.diff`

WPL-003:

- Baseline output: `evals/runs/write-plan-1/wpl-003-baseline-output.md`
- Baseline diff: `evals/runs/write-plan-1/wpl-003-baseline-output.diff`
- Final with-skill output: `evals/runs/write-plan-2/wpl-003-with-skill-output.md`
- Final with-skill diff: `evals/runs/write-plan-2/wpl-003-with-skill-output.diff`
