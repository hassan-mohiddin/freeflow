...
| docs-markdown-query | docs | freeflow-owned-tools | pass | yes | yes | yes | 1 | 352/524 | -48.86% | 0 | 3.52/3.52 | Deterministic repo retrieval selected 1 candidate(s); top result plugin-docs/output-router.md:5-9 (BM25-style scored section chunk with 12/12 query-token coverage). |
