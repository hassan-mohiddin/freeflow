...
- Baseline fixture: `evals/fixtures/tiny-saas-app`
- With-core fixture: `evals/fixtures/tiny-post-setup-source-conflict-app`
...
- `evals/runs/always-on-1/aon-001-baseline-output.md`
- `evals/runs/always-on-1/aon-001-baseline-output.diff`
- `evals/runs/always-on-1/aon-001-with-core-output.md`
- `evals/runs/always-on-1/aon-001-with-core-output.diff`
...
wc -c evals/runs/always-on-1/aon-001-*-output.diff
```
