...
Use `reports/runtime/eryx-python-proof-spike-1-report.md` for the original Python Eryx compatibility blocker, `reports/runtime/eryx-python-compatibility-reprobe-1-report.md` for the temp-only import workaround reprobe, `reports/runtime/eryx-python-proof-spike-2-report.md` for the 9/9 Eryx proof spike, and `reports/runtime/eryx-python-script-derive-execution-1-report.md` for the Eryx Python execution-engine evidence; Python execution requires `FREEFLOW_ERYX_ROOT`, Node `--experimental-wasm-jspi`, and explicit `scriptDerive` opt-in.
...
Use `reports/runtime/quickjs-script-derive-execution-1-report.md` for the current QuickJS JavaScript execution-engine evidence. Use `reports/runtime/eryx-python-script-derive-execution-1-report.md` for the current Eryx Python execution-engine evidence. Use `reports/runtime/jq-script-derive-execution-1-report.md` for the current jq execution-engine evidence. Use `reports/runtime/script-sandbox-probe-resource-hardening-1-report.md` for follow-up proof-probe resource hardening evidence. Script derive is still disabled by default; JavaScript, Python, and jq execute only through explicit proof-backed adapter roots.
