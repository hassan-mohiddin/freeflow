...
import { QuickJSRunner, type WorkerSetup } from "./quickjs.js";
import { hostFrame, type GuestFrame } from "./protocol.js";
...
const send = (frame: GuestFrame) => parentPort.postMessage(frame);
