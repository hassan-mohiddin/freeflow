import type { ContextOperationResult } from "./types.js";
...
function rejected(operation: "archive" | "restore", message: string): ContextOperationResult {
  return { status: "rejected", operation, changed: [], message };
}

function parseOperation(params: ContextToolParams): "archive" | "restore" | undefined {
  return params.operation === "archive" || params.operation === "restore" ? params.operation : undefined;
}

export function registerContextVirtualizationTool(
