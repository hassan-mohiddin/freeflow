...
export function registerRouterTools(pi) {
    pi.registerTool({
        ...
        description: "Inspect effective Freeflow router, observed-routing, script-transform, vault, warnings, and non-destructive migration recommendations.",
    ...
    pi.registerTool({
        name: "freeflow_run",
        label: "Freeflow Run",
        description: "Run a shell command or sandboxed script producer, vault captured stdout/stderr when storage policy requires it, and return compact routed evidence plus an outputId.",
    ...
    pi.registerTool({
        ...
        description: "Run independent Freeflow-owned run/search operations in parallel and return one compact summary while preserving full child results in details.result.steps.",
