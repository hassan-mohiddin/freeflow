...
export const CONTEXT_CONTROL_RULE_VERSION = "0.3";
...
export function analyzeLifecycle(sources) {
  ...
  const broadSearches = new Map();
  const add = (source, lane, rule, replacement, confidence, reason, facts, limitation) => {
