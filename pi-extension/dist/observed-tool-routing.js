...
export async function handleObservedToolRouting(event, ctx) {
...
function rawObservedResult(event) {
...
function observedDetails(event, routed) {
    return {
...
function formatObservedRoutedResult(routed) {
...
function formatObservedFailOpen(routed) {
