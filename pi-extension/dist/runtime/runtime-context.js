...
const SESSION_CORE_KEYS = new Set(["enabled", "interactionContract", "skillsEnabled"]);
  ...
  return {
    ...
    contextControl: {
      ...
      ...(contextControlEffective
        ? {}
        : {
            blockingReason: disabledReason ?? { code: "disabled", message: "Context Control is disabled" },
          }),
    },
