...
| [`tdd`](../skills/tdd/SKILL.md) | One accepted behavior through RED/GREEN/REFACTOR | `execute-work`, `workflow`, `track-work`, `design-for-depth`, `diagnose-failure` | [`test-design`](../skills/tdd/references/test-design.md), [`code-practices`](../skills/execute-work/references/code-practices.md) |
