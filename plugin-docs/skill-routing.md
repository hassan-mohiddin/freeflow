...
| [`track-work`](../skills/track-work/SKILL.md) | Working Record selection, living state, and deterministic transitions | `workflow`, `discuss`, `execute-work`, `handoff` | None — command mechanics live in `skills/track-work/scripts/working-record.mjs` |
...
| [`review-artifact`](../skills/review-artifact/SKILL.md) | Artifact self-review or selected independent artifact judgment | `workflow`, `track-work`, `diagnose-failure` | [`reviewer-prompt`](../skills/review-artifact/references/reviewer-prompt.md) for independent review |
| [`review-work`](../skills/review-work/SKILL.md) | Work self-review or selected independent work judgment | `verify-work`, `workflow`, `execute-work`, `track-work`, `diagnose-failure` | [`reviewer-prompt`](../skills/review-work/references/reviewer-prompt.md), [`security-risk-lens`](../skills/review-work/references/security-risk-lens.md) |
...
| [`diagnose-failure`](../skills/diagnose-failure/SKILL.md) | Supported cause for unexplained, repeated, flaky, or performance failure | `workflow`, `decision-gate`, `design-for-depth`, `execute-work`, `tdd`, `simplify-code`, `verify-work` | [`diagnostic-loop-catalog`](../skills/diagnose-failure/references/diagnostic-loop-catalog.md), [`flaky-and-performance`](../skills/diagnose-failure/references/flaky-and-performance.md) |
