...
| [`discuss`](../skills/discuss/SKILL.md) | Collaborative exploration and direction revision | `decision-gate`, `diagnose-failure`, `design-for-depth`, `track-work`, `write-spec`, `write-plan` | [`checkpoints`](../skills/discuss/references/checkpoints.md) |
| [`track-work`](../skills/track-work/SKILL.md) | Living Working Record state and transitions | `workflow`, `discuss`, `handoff` | [`working-record-schema`](../skills/track-work/references/working-record-schema.md) — required before record mutation or resume |
...
| Skill | Owner | Routes / composition | References |
| --- | --- | --- | --- |
| [`execute-work`](../skills/execute-work/SKILL.md) | Bounded concrete changes and execution feedback | `workflow`, `track-work`, `verify-work`, `review-work` | [`execution-loop`](../skills/execute-work/references/execution-loop.md), [`code-practices`](../skills/execute-work/references/code-practices.md) |
| [`tdd`](../skills/tdd/SKILL.md) | One accepted behavior through RED/GREEN/REFACTOR | `workflow`, `diagnose-failure` | [`test-design`](../skills/tdd/references/test-design.md), [`code-practices`](../skills/execute-work/references/code-practices.md) |
...
| [`diagnose-failure`](../skills/diagnose-failure/SKILL.md) | Supported cause for unexplained, repeated, flaky, or performance failure | `workflow`, `decision-gate`, `design-for-depth`, `execute-work`, `tdd`, `verify-work` | [`feedback-loop-catalog`](../skills/diagnose-failure/references/feedback-loop-catalog.md), [`flaky-and-performance`](../skills/diagnose-failure/references/flaky-and-performance.md) |
