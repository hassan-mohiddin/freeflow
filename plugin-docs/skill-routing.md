...
| [`workflow`](../skills/workflow/SKILL.md) | Work agreement, readiness, Interaction Lifecycle, Feedback Loop, narrow re-entry, selected checkpoints, Supported Exit | `action-selection`, `bypass`, `commit-work`, `decision-gate`, `design-for-depth`, `diagnose-failure`, `discuss`, `execute-work`, `finish-branch`, `handoff`, `launch-work`, `migration-work`, `release-work`, `review-artifact`, `review-work`, `simplify-code`, `track-work`, `verify-work`, `write-plan`, `write-spec` | [`domain-skill-composition`](../skills/workflow/references/domain-skill-composition.md) |
...
| [`discuss`](../skills/discuss/SKILL.md) | Collaborative outcome/approach understanding and bounded learning assessment | `action-selection`, `decision-gate`, `design-for-depth`, `diagnose-failure`, `execute-work`, `track-work`, `workflow`, `write-plan`, `write-spec` | [`discussion-continuity`](../skills/discuss/references/discussion-continuity.md) |
...
| [`design-for-depth`](../skills/design-for-depth/SKILL.md) | Compositional design lens for boundaries, interfaces, ownership, state, and failure | `decision-gate`, `diagnose-failure`, `simplify-code`, `workflow` | [`design-pressure-signals`](../skills/design-for-depth/references/design-pressure-signals.md), [`implementation-decisions`](../skills/design-for-depth/references/implementation-decisions.md), [`interface-design-loop`](../skills/design-for-depth/references/interface-design-loop.md), [`module-and-dependency-design`](../skills/design-for-depth/references/module-and-dependency-design.md), [`software-design-philosophy`](../skills/design-for-depth/references/software-design-philosophy.md), [`state-and-failure-boundaries`](../skills/design-for-depth/references/state-and-failure-boundaries.md) |

## Artifacts, Review, And Evidence

| Skill | Owner | Routes / composition | References |
| --- | --- | --- | --- |
| [`write-spec`](../skills/write-spec/SKILL.md) | Stable accepted durable content | `decision-gate`, `design-for-depth`, `discuss`, `review-artifact`, `track-work` | [`artifact-standards`](../skills/write-spec/references/artifact-standards.md), [`decision-records`](../skills/write-spec/references/decision-records.md), [`spec-shapes`](../skills/write-spec/references/spec-shapes.md) |
...
| [`verify-work`](../skills/verify-work/SKILL.md) | Active-agent factual claim verification | — | [`browser-runtime-evidence`](../skills/verify-work/references/browser-runtime-evidence.md), [`integration-evidence`](../skills/verify-work/references/integration-evidence.md), [`performance-evidence`](../skills/verify-work/references/performance-evidence.md), [`test-design`](../skills/verify-work/references/test-design.md) |

## Execution And Delivery

| Skill | Owner | Routes / composition | References |
| --- | --- | --- | --- |
| [`execute-work`](../skills/execute-work/SKILL.md) | Bounded preparation, implementation or learning execution, evidence, and in-Slice continuation | `action-selection`, `decision-gate`, `design-for-depth`, `diagnose-failure`, `discuss`, `review-work`, `simplify-code`, `track-work`, `verify-work`, `workflow` | [`code-practices`](../skills/execute-work/references/code-practices.md), [`execute-work-edges`](../skills/execute-work/references/execute-work-edges.md), [`domain-skill-composition`](../skills/workflow/references/domain-skill-composition.md), [`test-design`](../skills/verify-work/references/test-design.md) |
| [`simplify-code`](../skills/simplify-code/SKILL.md) | Behavior-preserving simplification | `design-for-depth`, `diagnose-failure`, `migration-work`, `verify-work`, `workflow` | [`code-practices`](../skills/execute-work/references/code-practices.md), [`simplification-patterns`](../skills/simplify-code/references/simplification-patterns.md), [`test-design`](../skills/verify-work/references/test-design.md) |
...
1. the Interaction Contract and Workflow establishing the agreement and readiness;
2. Workflow selecting the narrowest owner without requiring a fixed phase or artifact sequence;
