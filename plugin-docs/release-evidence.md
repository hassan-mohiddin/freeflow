...
- Capture/transform/provider eval: targeted historical eval passed 14/14 objective gates for read-only provider capture, web-shaped capture recovery, long-log transform, and provider-summary category scoping.
