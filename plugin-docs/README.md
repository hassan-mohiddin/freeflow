...
Press `t` to trust/enable the Freeflow `SessionStart` hook when Codex marks it as needing review. Once enabled, plugin-bundled hooks load workflow, interview-gate, discover, and workflow-map context at session start, resume, clear, and compact.
