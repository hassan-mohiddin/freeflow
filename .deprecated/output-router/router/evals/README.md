...
Runtime fixtures, deterministic evaluators, and durable reports owned by Freeflow Router.

- `fixtures/`: router regression inputs.
- `scripts/`: targeted runtime and adapter evaluators.
