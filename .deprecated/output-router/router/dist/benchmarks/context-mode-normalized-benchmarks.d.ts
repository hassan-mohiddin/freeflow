...
export declare function runContextModeNormalizedBenchmarks(
  options?: RunContextModeNormalizedBenchmarksOptions,
): Promise<ContextModeNormalizedBenchmarkReport>;
export declare function renderContextModeNormalizedBenchmarkReport(
...
export declare function writeContextModeNormalizedBenchmarkReports(
  report: ContextModeNormalizedBenchmarkReport,
