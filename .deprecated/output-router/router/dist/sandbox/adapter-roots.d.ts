...
export declare function defaultScriptTransformAdapterRoot(
  language: ScriptTransformAdapterLanguage,
  env?: NodeJS.ProcessEnv,
): string;
export declare function resolveScriptTransformAdapterRoot(
  language: ScriptTransformAdapterLanguage,
  env?: NodeJS.ProcessEnv,
...
export declare function scriptTransformAdapterInstallSpecs(
  languages?: readonly ScriptTransformAdapterLanguage[],
): string[];
