...
export declare function findExactDuplicateCommandOutput(
  vault: VaultHandle,
  options: FindExactDuplicateCommandOutputOptions,
): Promise<SessionIndexEntry | undefined>;
export declare function findExactDuplicateTextOutput(
  vault: VaultHandle,
  options: FindExactDuplicateTextOutputOptions,
): Promise<SessionIndexEntry | undefined>;
export declare function storeCommandOutput(
  vault: VaultHandle,
...
export declare function storeMetadataOutput(
  vault: VaultHandle,
  options: StoreMetadataOutputOptions,
): Promise<MetadataOutputRecord>;
export declare function storeRepoFileReference(
  vault: VaultHandle,
...
export declare function readOutputText(
  vault: VaultHandle,
  sessionId: string,
  outputId: string,
  stream: OutputStream,
