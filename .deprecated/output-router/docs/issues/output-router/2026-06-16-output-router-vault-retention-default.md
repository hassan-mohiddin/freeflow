...
> **Type:** Issue
> **Status:** Resolved
> **Source:** `docs/specs/output-router/freeflow-output-router-design.md`; `docs/plans/output-router/2026-06-16-freeflow-output-router-implementation-plan.md` Slice 1.
