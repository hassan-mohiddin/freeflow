...
- `docs/plans/output-router/2026-06-16-freeflow-output-router-excellence-implementation-plan.md` — Slices 0-9 and final verification expectations.
- `docs/specs/output-router/freeflow-output-router-design.md` — router core principles: explicit routed tools, raw capture first, exact recovery, no surprise semantics.
- `docs/specs/output-router/freeflow-output-router-excellence-spec.md` — accuracy-first success model and benchmark expectations.
