...
> **Type:** Spec
> **Status:** Draft
> **Source:** 2026-06-16 output-routing design discussion; `docs/specs/output-router/freeflow-capability-and-output-routing-spec.md`; Pi extension/skill behavior reviewed earlier in the same design thread.
...
- Runtime-facing safety policy location: `capabilities/output-router/references/safety-policy.md`.
...
- The runtime-facing skill path is `capabilities/output-router/SKILL.md`.
