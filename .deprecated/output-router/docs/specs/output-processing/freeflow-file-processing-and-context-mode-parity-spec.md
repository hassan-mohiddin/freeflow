...
> **Type:** Spec
> **Status:** Draft
> **Source:** Real Context Mode MCP benchmark, Context Mode source inspection, `docs/specs/output-processing/freeflow-context-saving-native-tools-redesign-spec.md`, and current Freeflow router behavior.
