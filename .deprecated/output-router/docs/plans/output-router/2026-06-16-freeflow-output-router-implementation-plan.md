...
> **Type:** Plan
> **Status:** Draft
> **Source:** `docs/specs/output-router/freeflow-output-router-design.md`; reviewed current `package.json`; `plugin-docs/architecture.md`; `pi-extension/index.js`.
...
- Default vault retention TTL is 7 days and recorded in `docs/issues/output-router/2026-06-16-output-router-vault-retention-default.md`.
