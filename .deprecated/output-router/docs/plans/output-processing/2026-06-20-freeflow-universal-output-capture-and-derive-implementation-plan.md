...
> **Source:** `docs/specs/output-processing/freeflow-universal-output-capture-and-derive-design.md` reviewed Pass on 2026-06-20; Slice 0 decisions owner-approved on 2026-06-22; Slices 1-3 verified on 2026-06-22; Slice 4 capability inspection on 2026-06-22

# Freeflow Universal Output Capture And Derive Implementation Plan

## Goal

Implement the universal evidence direction from `docs/specs/output-processing/freeflow-universal-output-capture-and-derive-design.md` without changing Freeflow's core philosophy:
...
- `docs/specs/output-processing/freeflow-universal-output-capture-and-derive-design.md`

Foundational router contract:

- `docs/specs/output-router/freeflow-output-router-design.md`
...
- codebase-memory-mcp research captured in `docs/handoffs/output-router/2026-06-19-external-code-intelligence-integration-handoff.md`.
