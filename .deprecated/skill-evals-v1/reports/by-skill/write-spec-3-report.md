...
- Output: `evals/runs/write-spec-3/wsp-003-baseline-output.md`
- Diff: `evals/runs/write-spec-3/wsp-003-baseline-output.diff`

With skill:

- Output: `evals/runs/write-spec-4/wsp-003-with-skill-output.md`
- Diff: `evals/runs/write-spec-4/wsp-003-with-skill-output.diff`
