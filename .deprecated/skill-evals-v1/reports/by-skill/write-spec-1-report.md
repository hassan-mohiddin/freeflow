...
- Output: `evals/runs/write-spec-1/wsp-001-baseline-output.md`
- Diff: `evals/runs/write-spec-1/wsp-001-baseline-output.diff`

With skill:

- Output: `evals/runs/write-spec-3/wsp-001-with-skill-output.md`
- Diff: `evals/runs/write-spec-3/wsp-001-with-skill-output.diff`
