...
- `evals/prompts/rev-003.txt`
- `REV-003` entry in `evals/registries/fixture-evals.json`
...
Tightened `skills/review-work/SKILL.md` for multi-item feedback:
...
- Output: `evals/runs/review-work-5/rev-003-baseline-output.md`
- Diff: `evals/runs/review-work-5/rev-003-baseline-output.diff`

With skill:

- Output: `evals/runs/review-work-8/rev-003-with-skill-output.md`
- Diff: `evals/runs/review-work-8/rev-003-with-skill-output.diff`
