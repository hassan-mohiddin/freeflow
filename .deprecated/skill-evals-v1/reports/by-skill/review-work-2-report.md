...
- `evals/fixtures/tiny-review-work-app/`
- `evals/prompts/rev-002.txt`
...
- Output: `evals/runs/review-work-4/rev-002-baseline-output.md`
- Diff: `evals/runs/review-work-4/rev-002-baseline-output.diff`

With skill:

- Output: `evals/runs/review-work-4/rev-002-with-skill-output.md`
- Diff: `evals/runs/review-work-4/rev-002-with-skill-output.diff`
