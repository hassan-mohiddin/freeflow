...
- `evals/fixtures/tiny-team-app/`
- `evals/prompts/grc-001.txt`
- `GRC-001` entry in `evals/registries/fixture-evals.json`
...
- Output: `evals/runs/grill-context-1/grc-001-baseline-output.md`
- Diff: `evals/runs/grill-context-1/grc-001-baseline-output.diff`

Final with skill:

- Output: `evals/runs/grill-context-2/grc-001-with-skill-output.md`
- Diff: `evals/runs/grill-context-2/grc-001-with-skill-output.diff`
