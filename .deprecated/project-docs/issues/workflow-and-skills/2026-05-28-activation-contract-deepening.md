...
- [Architecture review candidates](../artifacts/interface-reviews/2026-05-28-architecture-review-candidates.html)

Focused interface review:

- [Activation contract interface review](../artifacts/interface-reviews/2026-05-28-activation-contract-interface-review.html)
...
- `docs/research/memory-and-artifacts/freeflow-always-on-memory.md`
