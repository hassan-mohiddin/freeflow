...
export declare const DELEGATION_LAYOUT_SLOTS: readonly [
  "inline",
  "right-top",
  "right-bottom",
...
export declare function planDelegationLayoutAllocation(
  input: PlanDelegationLayoutAllocationInput,
): DelegationLayoutAllocation;
export declare function normalizeDelegationLayoutAllocation(
  input: DelegationLayoutAllocation,
): DelegationLayoutAllocation;
export {};
