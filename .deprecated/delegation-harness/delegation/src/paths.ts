...
export interface DelegationTaskPaths {
  ...
  eventsJsonl: string;
  routesJsonl: string;
  routeApplicationsJsonl: string;
  leasesJsonl: string;
  activeLeasesJson: string;
  wakeAttemptsJsonl: string;
  layoutJson: string;
  parentAlertsJson: string;
  waitStateJson: string;
  executionMapJson: string;
  executionEnvelopesDir: string;
  terminalOutcomesDir: string;
  planningReportPublicationsDir: string;
  planningReportAcceptedDir: string;
  planningReportRejectedDir: string;
  decisionsMd: string;
  modelDir: string;
  agentsDir: string;
...
export function delegationRootForRepo(repoRoot: string): string {
...
export function validateSafeName(value: string, label = "name"): string {
  if (value.length === 0) {
...
export function taskPaths(root: string, taskId: string): DelegationTaskPaths {
...
export function agentPaths(root: string, taskId: string, agentId: string): DelegationAgentPaths {
...
export function safeModelFilePath(modelDir: string, fileName: string): string {
