...
const LEAF_WRITER_TOOL_NAMES = [...WRITER_TOOL_NAMES, ...LEAF_LIFECYCLE_TOOL_NAMES] as const;
const LEAF_READ_ONLY_TOOL_NAMES = [...READ_ONLY_TOOL_NAMES, ...LEAF_LIFECYCLE_TOOL_NAMES] as const;
const LEAF_CHECK_RUNNER_TOOL_NAMES = [...CHECK_RUNNER_TOOL_NAMES, ...LEAF_LIFECYCLE_TOOL_NAMES] as const;
...
export function isChildLifecycleDelegationTool(toolName: string): boolean {
  return CHILD_LIFECYCLE_TOOL_NAMES.includes(toolName as (typeof CHILD_LIFECYCLE_TOOL_NAMES)[number]);
}

export function isReadRecoveryDelegationTool(toolName: string): boolean {
  return READ_RECOVERY_TOOL_NAMES.includes(toolName as (typeof READ_RECOVERY_TOOL_NAMES)[number]);
}
...
export function returnProtocolForActiveTools(role: DelegationRole, activeTools: readonly string[]): string[] {
