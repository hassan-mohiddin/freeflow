...
Capture the issues found during a read-only audit of the Freeflow output router so future work can fix them deliberately rather than as scattered patches.
