...
import { CONTRIBUTOR_COMMANDS, WORKFLOW_COMMANDS, getRuntimeContext, handleWorkflowCommand, hasFreeflowActivation, hasOutputRouterActivation, readModeState, readOutputRouterConfig, refreshRuntimeContext, restoreModeOverride, runtimeContext, setModeStatus, skillPrompt, notifyRouterConfigWarnings, } from "./runtime-context.js";
    ...
    pi.on("before_agent_start", async (event, ctx) => {
        ...
        return {
            systemPrompt: event.systemPrompt +
                "\n\n" +
                runtimeContext(modeState, freeflowContext, routerConfigResult, hasFreeflowActivation(event.systemPrompt), hasOutputRouterActivation(event.systemPrompt)),
        };
    });
