...
} from "../dist/benchmark-harness.js";
...
test("benchmark harness derives generated JSON paths and parses shared CLI args", () => {
  ...
  assert.equal(
    defaultJsonRunReportPath(resolve(process.cwd(), "plugins/freeflow/evals/reports/runtime/output-router-benchmark-1-report.md")),
    resolve(process.cwd(), "plugins/freeflow/evals/runs/output-router/output-router-benchmark-1-report.json"),
  );
  assert.equal(
    defaultJsonRunReportPath(resolve(process.cwd(), "plugins/freeflow/evals/reports/runtime/custom")),
    resolve(process.cwd(), "plugins/freeflow/evals/runs/output-router/custom.json"),
  );
