...
export function searchRepoEvidenceCandidates(options) {
...
export function findBestLineForQuery(lines, query) {
...
function scoreCandidateChunk(chunk, queryTokens, normalizedQueryPhrase, stats, options) {
