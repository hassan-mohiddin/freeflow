...
- Output: `plugins/freeflow/evals/runs/diagnose-failure-1/dia-001-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/diagnose-failure-1/dia-001-baseline-output.diff`

With skill:

- Output: `plugins/freeflow/evals/runs/diagnose-failure-3/dia-001-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/diagnose-failure-3/dia-001-with-skill-output.diff`
