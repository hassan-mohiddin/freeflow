...
- Output: `plugins/freeflow/evals/runs/review-artifact-3/rar-002-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/review-artifact-3/rar-002-baseline-output.diff`

With skill:

- Output: `plugins/freeflow/evals/runs/review-artifact-3/rar-002-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/review-artifact-3/rar-002-with-skill-output.diff`
