...
git diff --check
wc -c plugins/freeflow/evals/runs/diagnose-failure-6/dia-002-with-skill-output.diff \
  plugins/freeflow/evals/runs/diagnose-failure-6/dia-003-with-skill-output.diff \
  plugins/freeflow/evals/runs/diagnose-failure-8/dia-001-with-skill-output.diff \
  plugins/freeflow/evals/runs/diagnose-failure-9/cmd-011-with-skill-output.diff
```
