...
Tested whether the installed Freeflow core block changes behavior after setup, without loading any Freeflow skill file.
...
- Baseline fixture: `plugins/freeflow/evals/fixtures/tiny-saas-app`
- With-core fixture: `plugins/freeflow/evals/fixtures/tiny-post-setup-source-conflict-app`

The with-core fixture is the same app plus post-setup Freeflow files:
...
Both runs used the harness baseline variant, so neither run loaded a Freeflow skill file. The behavior difference comes from the installed repo instruction file.
...
- `plugins/freeflow/evals/runs/always-on-1/aon-001-baseline-output.md`
- `plugins/freeflow/evals/runs/always-on-1/aon-001-baseline-output.diff`
- `plugins/freeflow/evals/runs/always-on-1/aon-001-with-core-output.md`
- `plugins/freeflow/evals/runs/always-on-1/aon-001-with-core-output.diff`
...
wc -c plugins/freeflow/evals/runs/always-on-1/aon-001-*-output.diff
```
