...
- `plugins/freeflow/skills/commit-work/`
...
bash -n plugins/freeflow/evals/fixtures/tiny-commit-staged-mixed-app/.freeflow-eval-setup.sh
wc -l plugins/freeflow/skills/commit-work/SKILL.md plugins/freeflow/skills/commit-work/references/staging-decisions.md
git diff --check
