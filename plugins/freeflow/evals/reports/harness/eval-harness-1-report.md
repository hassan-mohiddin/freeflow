# Freeflow Eval Harness Report - 1
...
The script resolves evals from `registries/fixture-evals.json` and delegates to the existing Codex fixture runner.
...
- `FREEFLOW_DRY_RUN=1` prints the resolved run without launching a nested model.
...
```text
fixture=.../plugins/freeflow/evals/fixtures/tiny-saas-app
```

`AON-001 with-core` resolves to the post-setup fixture:

```text
fixture=.../plugins/freeflow/evals/fixtures/tiny-post-setup-source-conflict-app
```
