...
- Output: `plugins/freeflow/evals/runs/review-artifact-1/rar-001-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/review-artifact-1/rar-001-baseline-output.diff`

With skill:

- Output: `plugins/freeflow/evals/runs/review-artifact-5/rar-001-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/review-artifact-5/rar-001-with-skill-output.diff`
