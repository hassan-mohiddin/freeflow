...
- `plugins/freeflow/skills/research-brief/SKILL.md`
...
- `plugins/freeflow/evals/prompts/rbr-002.txt`
- `plugins/freeflow/evals/prompts/rbr-003.txt`
- `RBR-002` and `RBR-003` entries in `plugins/freeflow/evals/registries/fixture-evals.json`
- `research-brief` evidence links in `plugins/freeflow/evals/registries/skill-evidence.json`
...
- Output: `plugins/freeflow/evals/runs/research-brief-2/rbr-002-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/research-brief-2/rbr-002-with-skill-output.diff`
- Output: `plugins/freeflow/evals/runs/research-brief-2/rbr-003-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/research-brief-2/rbr-003-with-skill-output.diff`
