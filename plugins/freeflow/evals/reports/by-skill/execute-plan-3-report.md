...
- `plugins/freeflow/skills/execute-plan/references/execution-map.md`
...
```sh
plugins/freeflow/evals/scripts/grade-fixture-eval.sh XPL-005 --output plugins/freeflow/evals/runs/execute-plan-depth-pi-2/xpl-005-with-skill-output.md
plugins/freeflow/evals/scripts/grade-fixture-eval.sh XPL-006 --output plugins/freeflow/evals/runs/execute-plan-depth-pi-2/xpl-006-with-skill-output.md
plugins/freeflow/evals/scripts/grade-fixture-eval.sh XPL-001 --output plugins/freeflow/evals/runs/execute-plan-depth-regression-pi-1/xpl-001-with-skill-output.md
plugins/freeflow/evals/scripts/grade-fixture-eval.sh XPL-004 --output plugins/freeflow/evals/runs/execute-plan-depth-regression-pi-1/xpl-004-with-skill-output.md
```
