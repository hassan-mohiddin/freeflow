...
- `plugins/freeflow/evals/prompts/rbr-001.txt`
- `RBR-001` entry in `plugins/freeflow/evals/registries/fixture-evals.json`
...
- Output: `plugins/freeflow/evals/runs/research-brief-1/rbr-001-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/research-brief-1/rbr-001-baseline-output.diff`

With skill:

- Output: `plugins/freeflow/evals/runs/research-brief-1/rbr-001-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/research-brief-1/rbr-001-with-skill-output.diff`
