...
- `plugins/freeflow/evals/prompts/rev-003.txt`
- `REV-003` entry in `plugins/freeflow/evals/registries/fixture-evals.json`
...
Tightened `plugins/freeflow/skills/review-work/SKILL.md` for multi-item feedback:
...
- Output: `plugins/freeflow/evals/runs/review-work-5/rev-003-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/review-work-5/rev-003-baseline-output.diff`

With skill:

- Output: `plugins/freeflow/evals/runs/review-work-8/rev-003-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/review-work-8/rev-003-with-skill-output.diff`
