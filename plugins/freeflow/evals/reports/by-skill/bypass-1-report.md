...
```text
plugins/freeflow/skills/bypass/SKILL.md
```
...
- `plugins/freeflow/evals/prompts/byp-001.txt`
- `plugins/freeflow/evals/prompts/byp-002.txt`
- `BYP-001` and `BYP-002` entries in `plugins/freeflow/evals/registries/fixture-evals.json`
...
- Output: `plugins/freeflow/evals/runs/bypass-1/byp-001-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/bypass-1/byp-001-baseline-output.diff`

BYP-001 final with skill:

- Output: `plugins/freeflow/evals/runs/bypass-2/byp-001-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/bypass-2/byp-001-with-skill-output.diff`

BYP-002 baseline:

- Output: `plugins/freeflow/evals/runs/bypass-1/byp-002-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/bypass-1/byp-002-baseline-output.diff`

BYP-002 final with skill:

- Output: `plugins/freeflow/evals/runs/bypass-3/byp-002-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/bypass-3/byp-002-with-skill-output.diff`
