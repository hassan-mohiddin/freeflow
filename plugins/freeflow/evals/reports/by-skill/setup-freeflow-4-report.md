...
- `plugins/freeflow/evals/prompts/stp-010.txt`
...
```sh
plugins/freeflow/evals/scripts/grade-fixture-eval.sh STP-010 --output plugins/freeflow/evals/runs/setup-8/stp-010-baseline-old-runtime-output.md
# fail: setup-required-files pass; workflow-loaded-output fail

plugins/freeflow/evals/scripts/grade-fixture-eval.sh STP-010 --output plugins/freeflow/evals/runs/setup-8/stp-010-with-skill-output.md
