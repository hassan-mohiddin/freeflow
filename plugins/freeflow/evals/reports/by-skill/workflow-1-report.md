...
```sh
plugins/freeflow/evals/scripts/grade-fixture-eval.sh WRC-002 --output plugins/freeflow/evals/runs/workflow-pi-1/wrc-002-with-skill-output.md
plugins/freeflow/evals/scripts/grade-fixture-eval.sh WRC-001 --output plugins/freeflow/evals/runs/workflow-pi-2/wrc-001-with-skill-output.md
```
