...
Added `IVG-001` to `registries/fixture-evals.json`.
...
- Diff: `plugins/freeflow/evals/runs/interview-gate-1/ivg-001-with-skill-output.diff`
...
- Output: `plugins/freeflow/evals/runs/handoff-6/hof-001-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/handoff-6/hof-001-with-skill-output.diff`
