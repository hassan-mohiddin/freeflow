...
- `REV-002` entry in `registries/fixture-evals.json`
...
- Output: `plugins/freeflow/evals/runs/review-work-4/rev-002-baseline-output.md`
- Diff: `plugins/freeflow/evals/runs/review-work-4/rev-002-baseline-output.diff`

With skill:

- Output: `plugins/freeflow/evals/runs/review-work-4/rev-002-with-skill-output.md`
- Diff: `plugins/freeflow/evals/runs/review-work-4/rev-002-with-skill-output.diff`
