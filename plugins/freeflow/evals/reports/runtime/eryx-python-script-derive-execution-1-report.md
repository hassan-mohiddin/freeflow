...
The dedicated proof report is `plugins/freeflow/evals/reports/runtime/eryx-python-proof-spike-2-report.md`.
...
```text
npm run build && node --test plugins/freeflow/router/tests/derive.test.js plugins/freeflow/router/tests/script-sandbox.test.js plugins/freeflow/router/tests/pi-extension-derive.test.js plugins/freeflow/router/tests/pi-extension.test.js
```
...
FREEFLOW_ERYX_ROOT=/tmp/freeflow-eryx-proof-run-87KaRW/node_modules/@bsull/eryx \
  node --experimental-wasm-jspi --test plugins/freeflow/router/tests/derive.test.js --test-name-pattern "Eryx adapter"
```
