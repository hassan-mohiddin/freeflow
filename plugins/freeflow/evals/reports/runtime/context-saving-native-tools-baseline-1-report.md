...
### retrieve-repo-query
- recovery: Use freeflow_retrieve action=expand with evidenceId=ev_99fb47209c30c4b8 for more surrounding context, action=locate for candidate paths, or action=retrieve with path=docs/output-router.md for an explicit span.
- evidence: `docs/output-router.md:1-9`

### retrieve-repo-exact-range
- recovery: Use freeflow_retrieve action=expand with evidenceId=ev_fb0315fc354ab431 for more context from docs/output-router.md.
- evidence: `docs/output-router.md:3-5`
...
- `plugins/freeflow/router/tests/pi-extension-derive.test.js`
...
- `plugins/freeflow/router/tests/vault-index.test.js`
