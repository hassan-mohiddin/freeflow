...
```text
npm run build && node --test plugins/freeflow/router/tests/script-sandbox.test.js plugins/freeflow/router/tests/derive.test.js plugins/freeflow/router/tests/pi-extension.test.js
```
