...
| --- | --- | --- |
| Domain term or glossary meaning | `CONTEXT.md` or existing glossary/domain doc | README as a fallback glossary |
...
Ask one focused question and recommend the narrowest durable destination supported by the repo.
