...
- Output: `plugins/pilot-workflow/evals/runs/review-artifact-1/rar-001-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/review-artifact-1/rar-001-baseline-output.diff`

With skill:

- Output: `plugins/pilot-workflow/evals/runs/review-artifact-5/rar-001-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/review-artifact-5/rar-001-with-skill-output.diff`
