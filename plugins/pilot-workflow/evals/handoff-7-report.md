...
- Prompt: `plugins/pilot-workflow/evals/prompts/hof-005.txt`
...
- HOF-005 final output: `plugins/pilot-workflow/evals/runs/handoff-7/hof-005/with-skill-output.md`
- HOF-005 final diff: `plugins/pilot-workflow/evals/runs/handoff-7/hof-005/with-skill-output.diff`
- HOF-002 output: `plugins/pilot-workflow/evals/runs/handoff-7/hof-002/with-skill-output.md`
- HOF-002 diff: `plugins/pilot-workflow/evals/runs/handoff-7/hof-002/with-skill-output.diff`
...
```sh
jq empty plugins/pilot-workflow/evals/handoff-evals.json
...
wc -c plugins/pilot-workflow/evals/runs/handoff-7/hof-005/with-skill-output.diff
```
