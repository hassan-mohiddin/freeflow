...
- `handoff-evals.json` says any created, modified, or deleted file fails.
- `handoff-eval-runbook.md` records the empty-diff rule.
- `run-codex-fixture-eval.sh` supports `PILOT_WORKFLOW_REQUIRE_EMPTY_DIFF=1` for strict focused runs.
...
- Output: `plugins/pilot-workflow/evals/runs/handoff-3/hof-003/current-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/handoff-3/hof-003/current-with-skill-output.diff`
- Result: failed because it created a repo memory handoff.

Post-fix focused run:

- Output: `plugins/pilot-workflow/evals/runs/handoff-3/hof-003/with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/handoff-3/hof-003/with-skill-output.diff`
...
PILOT_WORKFLOW_REQUIRE_EMPTY_DIFF=1 plugins/pilot-workflow/evals/scripts/run-codex-fixture-eval.sh \
  plugins/pilot-workflow/evals/fixtures/tiny-handoff-app \
  plugins/pilot-workflow/evals/runs/handoff-3/hof-003/with-skill \
  with-skill \
  plugins/pilot-workflow/evals/prompts/hof-003.txt \
  plugins/pilot-workflow/evals/runs/handoff-3/hof-003/with-skill-output.md \
  ...
  plugins/pilot-workflow/skills/verify-work/SKILL.md \
  plugins/pilot-workflow/skills/handoff/SKILL.md

wc -c plugins/pilot-workflow/evals/runs/handoff-3/hof-003/with-skill-output.diff
jq . plugins/pilot-workflow/evals/handoff-evals.json >/dev/null
...
- `handoff-evals.json` parsed with `jq`.
