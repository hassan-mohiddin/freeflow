...
```text
plugins/pilot-workflow/skills/grill-context/SKILL.md
```
...
- `plugins/pilot-workflow/evals/fixtures/tiny-team-app/`
- `plugins/pilot-workflow/evals/prompts/grc-001.txt`
- `GRC-001` entry in `plugins/pilot-workflow/evals/fixture-evals.json`
...
- Output: `plugins/pilot-workflow/evals/runs/grill-context-1/grc-001-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/grill-context-1/grc-001-baseline-output.diff`

Final with skill:

- Output: `plugins/pilot-workflow/evals/runs/grill-context-2/grc-001-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/grill-context-2/grc-001-with-skill-output.diff`
