...
- Output: `plugins/pilot-workflow/evals/runs/write-spec-3/wsp-003-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-spec-3/wsp-003-baseline-output.diff`

With skill:

- Output: `plugins/pilot-workflow/evals/runs/write-spec-4/wsp-003-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-spec-4/wsp-003-with-skill-output.diff`
