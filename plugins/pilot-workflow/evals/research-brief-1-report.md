...
```text
plugins/pilot-workflow/skills/research-brief/SKILL.md
```
...
- `plugins/pilot-workflow/evals/prompts/rbr-001.txt`
- `RBR-001` entry in `plugins/pilot-workflow/evals/fixture-evals.json`
...
- Output: `plugins/pilot-workflow/evals/runs/research-brief-1/rbr-001-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/research-brief-1/rbr-001-baseline-output.diff`

With skill:

- Output: `plugins/pilot-workflow/evals/runs/research-brief-1/rbr-001-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/research-brief-1/rbr-001-with-skill-output.diff`
