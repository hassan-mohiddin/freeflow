...
- Output: `plugins/pilot-workflow/evals/runs/write-plan-2/wpl-004-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-plan-2/wpl-004-baseline-output.diff`

First with-skill failure:

- Output: `plugins/pilot-workflow/evals/runs/write-plan-2/wpl-004-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-plan-2/wpl-004-with-skill-output.diff`

Final with skill:

- Output: `plugins/pilot-workflow/evals/runs/write-plan-3/wpl-004-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-plan-3/wpl-004-with-skill-output.diff`
