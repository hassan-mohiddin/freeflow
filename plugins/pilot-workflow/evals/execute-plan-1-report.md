...
- Baseline output: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-001-baseline-output.md`
- Baseline diff: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-001-baseline-output.diff`
- With-skill output: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-001-with-skill-output.md`
- With-skill diff: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-001-with-skill-output.diff`

XPL-002:

- Baseline output: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-002-baseline-output.md`
- Baseline diff: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-002-baseline-output.diff`
- With-skill output: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-002-with-skill-output.md`
- With-skill diff: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-002-with-skill-output.diff`

XPL-003:

- Baseline output: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-003-baseline-output.md`
- Baseline diff: `plugins/pilot-workflow/evals/runs/execute-plan-1/xpl-003-baseline-output.diff`
- Final with-skill output: `plugins/pilot-workflow/evals/runs/execute-plan-3/xpl-003-with-skill-output.md`
- Final with-skill diff: `plugins/pilot-workflow/evals/runs/execute-plan-3/xpl-003-with-skill-output.diff`
...
wc -c plugins/pilot-workflow/evals/runs/execute-plan-*/xpl-*.diff
```
