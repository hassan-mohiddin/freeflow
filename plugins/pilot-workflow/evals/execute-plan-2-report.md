...
- `plugins/pilot-workflow/evals/prompts/xpl-004.txt`
- `plugins/pilot-workflow/evals/fixtures/tiny-execute-plan-app/docs/plans/settings-title-with-bad-check.md`
- `plugins/pilot-workflow/evals/fixtures/tiny-execute-plan-app/checks/settings-and-billing-check.sh`
...
- Output: `plugins/pilot-workflow/evals/runs/execute-plan-2/xpl-004-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/execute-plan-2/xpl-004-baseline-output.diff`

With skill:

- Output: `plugins/pilot-workflow/evals/runs/execute-plan-2/xpl-004-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/execute-plan-2/xpl-004-with-skill-output.diff`
...
wc -c plugins/pilot-workflow/evals/runs/execute-plan-2/xpl-004-*-output.diff
```
