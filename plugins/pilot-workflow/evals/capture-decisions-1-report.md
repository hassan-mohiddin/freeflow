...
- `plugins/pilot-workflow/evals/prompts/cap-001.txt`
- `CAP-001` entry in `plugins/pilot-workflow/evals/fixture-evals.json`
...
- Output: `plugins/pilot-workflow/evals/runs/capture-decisions-1/cap-001-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/capture-decisions-1/cap-001-baseline-output.diff`

Final with skill:

- Output: `plugins/pilot-workflow/evals/runs/capture-decisions-7/cap-001-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/capture-decisions-7/cap-001-with-skill-output.diff`
