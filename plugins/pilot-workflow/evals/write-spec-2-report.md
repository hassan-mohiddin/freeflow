...
- Output: `plugins/pilot-workflow/evals/runs/write-spec-2/wsp-002-baseline-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-spec-2/wsp-002-baseline-output.diff`

With skill:

- Output: `plugins/pilot-workflow/evals/runs/write-spec-2/wsp-002-with-skill-output.md`
- Diff: `plugins/pilot-workflow/evals/runs/write-spec-2/wsp-002-with-skill-output.diff`
