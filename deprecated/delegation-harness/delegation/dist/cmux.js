...
function setRef(refs, kind, ref) {
    ...
    if (kind === "surface" && refs.surfaceRef === undefined)
        refs.surfaceRef = ref;
    if (kind === "pane" && refs.paneRef === undefined)
        refs.paneRef = ref;
    if (kind === "workspace" && refs.workspaceRef === undefined)
        refs.workspaceRef = ref;
    if (kind === "window" && refs.windowRef === undefined)
        refs.windowRef = ref;
}
