import { type DelegationActiveLeaseView, type DelegationLease, type DelegationRole, type PolicyBlockCode, type PolicyIntent } from "./types.js";
export declare const DELEGATION_LEASE_STATES: readonly ["issued", "active", "exhausted", "expired", "revoked"];
export declare const DELEGATION_LEASE_ACTIONS: readonly ["read", "edit", "run_allowlisted", "route", "spawn", "review", "verify"];
