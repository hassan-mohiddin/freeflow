...
> **Type:** Plan
> **Status:** Draft
> **Source:** `docs/specs/delegation/freeflow-pi-pane-delegation-harness-spec.md`

# Freeflow Pi Pane Delegation Harness Implementation Plan

## Goal

Implement the Freeflow Pi pane delegation harness described in `docs/specs/delegation/freeflow-pi-pane-delegation-harness-spec.md` as a Pi extension feature.
...
- `docs/designs/delegation/local-delegation-harness-design.md`
