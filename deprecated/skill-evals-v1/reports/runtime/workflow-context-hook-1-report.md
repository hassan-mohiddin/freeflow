...
```sh
evals/scripts/check-runtime-context-hook.sh
evals/scripts/grade-fixture-eval.sh WRC-001 --output evals/runs/workflow-context-1/wrc-001-baseline-clean-output.md
evals/scripts/grade-fixture-eval.sh WRC-001 --output evals/runs/workflow-context-1/wrc-001-with-workflow-output.md
