...
- Output: `evals/runs/handoff-3/hof-003/current-with-skill-output.md`
- Diff: `evals/runs/handoff-3/hof-003/current-with-skill-output.diff`
- Result: failed because it created a repo memory handoff.

Post-fix focused run:

- Output: `evals/runs/handoff-3/hof-003/with-skill-output.md`
- Diff: `evals/runs/handoff-3/hof-003/with-skill-output.diff`
...
FREEFLOW_REQUIRE_EMPTY_DIFF=1 evals/scripts/run-codex-fixture-eval.sh \
  ...
  evals/runs/handoff-3/hof-003/with-skill \
  with-skill \
  evals/prompts/hof-003.txt \
  evals/runs/handoff-3/hof-003/with-skill-output.md \
...
wc -c evals/runs/handoff-3/hof-003/with-skill-output.diff
jq . evals/registries/handoff-evals.json >/dev/null
