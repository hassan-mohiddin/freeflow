...
- `skills/design-for-depth/SKILL.md` keeps the active routing rules compact.
- `skills/design-for-depth/references/software-design-philosophy.md` holds deeper Ousterhout/Parnas/Feathers/ports-adapters guidance.
- `skills/design-for-depth/references/design-pressure-signals.md` holds examples and anti-patterns.
...
- `skills/design-for-depth/references/software-design-philosophy.md`
- `skills/design-for-depth/references/design-pressure-signals.md`
...
- `evals/fixtures/tiny-design-depth-app/`

Added prompt:

- `evals/prompts/dfd-001.txt`
...
- `evals/runs/workflow-depth/dfd-001-with-skill-output.md`

Key commands:

```sh
evals/scripts/run-fixture-eval-by-id.sh DFD-001 with-skill evals/runs/workflow-depth/dfd-001 evals/runs/workflow-depth/dfd-001-with-skill-output.md skills/design-for-depth/SKILL.md < /dev/null
evals/scripts/grade-fixture-eval.sh DFD-001 --output evals/runs/workflow-depth/dfd-001-with-skill-output.md
```
