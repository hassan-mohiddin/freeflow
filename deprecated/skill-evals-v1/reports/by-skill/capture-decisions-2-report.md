...
- `skills/capture-decisions/references/destination-guide.md`
...
- `evals/fixtures/tiny-decision-destination-app/`
- `evals/prompts/cap-002.txt`
- `CAP-002` entry in `evals/registries/fixture-evals.json`
...
- Output: `evals/runs/capture-decisions-2/cap-002-baseline-output.md`
- Diff: `evals/runs/capture-decisions-2/cap-002-baseline-output.diff`
- Diff size: `1206` bytes

CAP-002 final with skill:

- Output: `evals/runs/capture-decisions-3/cap-002-with-skill-output.md`
- Diff: `evals/runs/capture-decisions-3/cap-002-with-skill-output.diff`
- Diff size: `0` bytes

CAP-001 regression:

- Output: `evals/runs/capture-decisions-3/cap-001-with-skill-output.md`
- Diff: `evals/runs/capture-decisions-3/cap-001-with-skill-output.diff`
