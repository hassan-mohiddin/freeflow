...
- Output: `evals/runs/review-work-1/rev-001-baseline-output.md`
- Diff: `evals/runs/review-work-1/rev-001-baseline-output.diff`

With skill:

- Output: `evals/runs/review-work-3/rev-001-with-skill-output.md`
- Diff: `evals/runs/review-work-3/rev-001-with-skill-output.diff`
