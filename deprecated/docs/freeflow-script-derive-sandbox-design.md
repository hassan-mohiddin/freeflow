...
> **Source:** `docs/specs/output-processing/freeflow-observed-output-routing-vault-index-and-script-derive-design.md`, `docs/plans/output-processing/2026-06-24-freeflow-observed-output-routing-vault-index-script-derive-implementation-plan.md`, current router source under `router/src/`, and output-router safety policy.
