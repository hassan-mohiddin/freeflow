...
export type DelegationUnavailableCode = "cmux_binary_missing" | "cmux_command_unavailable" | "cmux_context_unavailable" | "child_pi_missing" | "store_unwritable";
...
export declare class CmuxAdapter {
    ...
    constructor(runner: CmuxCommandRunner, options?: {
        cwd?: string;
        timeoutMs?: number;
    });
...
export declare function buildCmuxSendKeyCommand(input: CmuxSendInput & {
    key: string;
}): string[];
