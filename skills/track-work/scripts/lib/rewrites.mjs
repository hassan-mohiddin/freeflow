  ...
  return {
    ...
    currentSlice: data.currentWork?.currentSlice
      ? {
          ...
          result: data.currentWork.currentSlice.result,
          reviewSummary: data.currentWork.currentSlice.reviewSummary,
          taskEffect: data.currentWork.currentSlice.taskEffect,
          blockerHistory: data.currentWork.currentSlice.blockerHistory,
          reopenHistory: data.currentWork.currentSlice.reopenHistory,
        }
      : null,
